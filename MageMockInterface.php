...
/**
 * Interface used for mocking all Mage calls. See Mage above.
 */
interface MageMockInterface
{
    /**
    ...
    public function getFileVersion($url);

    public function getFileVersionNet3($url);
}
